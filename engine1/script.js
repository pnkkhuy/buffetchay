...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"tv,page",prev:"",next:"",duration:20*100,delay:100*100,width:2339,height:1654,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"parallax",controls:true,controlsThumb:["data1/images/chuong_trinh_buffet_a4_a3_a2_a11.jpg", "data1/images/chuong_trinh_buffet_a4_a3_a2_a12.jpg"],responsive:3,fullScreen:true,gestures:2,onBeforeStep:0,images:0});